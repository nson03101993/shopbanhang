                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if($items->status == 0){
                                    ?>
                                        <a href="{{ route('unhide_tags', ['tags_id' => $items->id]) }}"><span style="font-size: 25px; color: red" class="fa fa-thumbs-down"></span></a>
                                    <?php
                                        }
                                        else{
                                    ?>
                                        <a href="{{ route('hide_tags', ['tags_id' => $items->id]) }}"><span style="font-size: 25px; color: blue" class="fa fa-thumbs-up"></span></a>
                                    <?php
                                        }
                                    ?>
                                </td>
                                <td>
                                    ...
                                    <a onClick="return confirm('Bạn có chắc chắn muốn xoá tags này?')" href="{{ route('delete_tags', ['tags_id' => $items->id ]) }}"><i class="fa fa-trash text-danger"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
